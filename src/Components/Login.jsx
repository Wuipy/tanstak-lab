...
export default function Login() {
  ...
  const displayError =
    error || (loginError ? "Credenciales incorrectas" : "");
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full py-2 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 text-white font-medium rounded focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
      >
